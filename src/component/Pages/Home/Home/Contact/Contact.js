...
const Contact = () => {
  return (
    <div className="contact-area w-50 shadow-lg p-5 mb-5 mt-5  mx-auto">
      <h2 className="text-center border-lg mb-5">Get in Touch</h2>
      <Form>
        ...
        <FloatingLabel className="mb-3" controlId="floatingTextarea2" label="Enter Your Message">
